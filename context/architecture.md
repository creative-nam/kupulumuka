...
| Offline layer | next-pwa (Workbox) + Dexie.js | Direct implementation of the offline-first requirement: Workbox caches the app shell + geographic snapshot; Dexie queues offline searches/contributions in IndexedDB with less boilerplate than raw IndexedDB. |
